...
@interface MealDiaryViewController : CoreDataTableViewController <UITableViewDelegate, UITableViewDataSource, AQGridViewDelegate, AQGridViewDataSource, FoodTreeViewControllerDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate> {
